...
Use S3 Connector to ingest documents from S3-compatible object storage into mAItion knowledge base.
...
- `S3_ACCOUNT1_SCHEDULES`: ingestion interval(s) in seconds
